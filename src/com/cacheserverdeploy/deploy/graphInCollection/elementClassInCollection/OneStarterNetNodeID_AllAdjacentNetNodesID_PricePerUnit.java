...
public class OneStarterNetNodeID_AllAdjacentNetNodesID_PricePerUnit 
	...
	public void addOrUpdateOneNetNodeID_PricePerUnitToAllAdjacentNetNodesID_PricePerUnit(
		...
		OneAdjacentNetNodeID_Capacity_PricePerUnit floorEndNetNodeID_Capacity_PricePerUnit=
				allAdjacentNetNodesID_Capacity_PricePerUnit.floor(oneAdjacentNetNodeID_Capacity_PricePerUnit);
		if(!oneAdjacentNetNodeID_Capacity_PricePerUnit.equals(floorEndNetNodeID_Capacity_PricePerUnit)){
			//集合中不包含此元素
			allAdjacentNetNodesID_Capacity_PricePerUnit.add(oneAdjacentNetNodeID_Capacity_PricePerUnit);
		}
		else{
			//集合中包含此元素，需要update
			if(floorEndNetNodeID_Capacity_PricePerUnit.pricePerUnit<=oneAdjacentNetNodeID_Capacity_PricePerUnit.pricePerUnit){
	 ...
	 */
	public TreeSet<OneAdjacentNetNodeID_Capacity_PricePerUnit> 
